...
func (u *authUsecaseImpl) AuthRegister(ctx context.Context, req *dto.UserRegisterDTO) (*dto.UserTokenDTO, error) {
...
func (u *authUsecaseImpl) AuthLogin(ctx context.Context, req *dto.UserLoginDTO) (*dto.UserTokenDTO, error) {
	msg.Validate(req)
	// Create a new Model User
